...
const selectableProjectTypes = computed(() => {
	...
	if (instance.value) {
		...
		if (supportedModLoaders.includes(instance.value.loader)) {
			mods = true
		}
	} else {
		dataPacks = true
	...
	const links = [
		{
			label: formatMessage({ id: 'browse.tabs.modpacks', defaultMessage: 'Modpacks' }),
			href: `/browse/modpack`,
			shown: modpacks,
		},
		{
			label: formatMessage({ id: 'browse.tabs.mods', defaultMessage: 'Mods' }),
			href: `/browse/mod`,
			shown: mods,
		},
		{
			...
			href: `/browse/resourcepack`,
		},
		{
			label: formatMessage({ id: 'browse.tabs.data-packs', defaultMessage: 'Data Packs' }),
			href: `/browse/datapack`,
			shown: dataPacks,
		},
		{
			label: formatMessage({ id: 'browse.tabs.shaders', defaultMessage: 'Shaders' }),
			href: `/browse/shader`,
		},
	]
...
const messages = defineMessages({
	...
	hideInstalledContent: {
		id: 'browse.hide-installed-content',
	...
	<Teleport v-if="filters" to="#sidebar-teleport-target">
		...
		>
			<Checkbox
				...
				:label="formatMessage(messages.hideInstalledContent)"
	...
	<div ref="searchWrapper" class="flex flex-col gap-3 p-6">
		...
		<div class="iconified-input">
			...
			<input
				...
				spellcheck="false"
				type="text"
				:placeholder="formatMessage(messages.searchPlaceholder, { projectType })"
			/>
