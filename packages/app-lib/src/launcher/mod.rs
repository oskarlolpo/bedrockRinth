...
pub async fn install_minecraft(
    ...
    if profile.loader == ModLoader::Bedrock {
        let _ = repairing;
        return bedrock::install_bedrock(profile, existing_loading_bar).await;
    }
...
pub async fn launch_minecraft(
    ...
    let looks_like_bedrock_pkg = game_version_lower
        .ends_with(".appx")
        ...
        || loader_version_lower.contains("github.com/onixclient/onix_compatible_appx/releases/download/");
