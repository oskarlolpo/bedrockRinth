...
const messages = defineMessages({
	stop: {
		id: 'instance.card.stop',
		defaultMessage: 'Stop',
	},
	play: {
		id: 'instance.card.play',
		defaultMessage: 'Play',
	},
	loading: {
		id: 'instance.card.loading',
		defaultMessage: 'Instance is loading...',
	},
	installing: {
		id: 'instance.card.installing',
		defaultMessage: 'Installing...',
	},
	repair: {
		id: 'instance.card.repair',
		defaultMessage: 'Repair',
	},
	played: {
		id: 'instance.card.played',
		defaultMessage: 'Played {time}',
	},
	neverPlayed: {
		id: 'instance.card.never-played',
