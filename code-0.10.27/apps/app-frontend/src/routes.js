...
export default new createRouter({
	...
	routes: [
		...
		{
			path: '/browse/bedrock/:contentType',
			name: 'Discover bedrock content',
			component: Pages.BedrockBrowse,
			meta: {
				breadcrumb: [{ name: 'Discover content' }],
			},
		},
		{
			path: '/browse/bedrock/:contentType/item',
			name: 'Bedrock content details',
			component: Pages.BedrockContentProject,
			meta: {
				breadcrumb: [{ name: 'Discover content' }],
			},
		},
