...
const messages = defineMessages({
	neverPlayed: {
		id: 'instance.never-played',
		defaultMessage: 'Never played',
	},
	installing: {
		id: 'instance.installing',
	...
	exportModpack: {
		id: 'instance.export-modpack',
		defaultMessage: 'Export modpack',
	},
	tabContent: {
		id: 'instance.tabs.content',
		defaultMessage: 'Content',
	},
	tabWorlds: {
		id: 'instance.tabs.worlds',
		defaultMessage: 'Worlds',
	},
	tabLogs: {
		id: 'instance.tabs.logs',
		defaultMessage: 'Logs',
	},
})
...
const handleOptionsClick = async (args) => {
	switch (args.option) {
		...
		case 'stop':
			...
			break
		case 'add_content':
			const browseProjectType = supportedModLoaders.includes(instance.value.loader)
				? 'mod'
				: 'datapack'
			await router.push({
